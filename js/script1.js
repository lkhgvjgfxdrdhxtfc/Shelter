...
const PETCARD9 = document.querySelector('.pets9');
...
PETCARD9.className = `pets9 ${getClass3()}`;

document.querySelector('.kat').querySelector('.pet-name').innerHTML = "Katrine";
document.querySelector('.kat').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/katrine.png)";


document.querySelector('.jen').querySelector('.pet-name').innerHTML  = "Jennifer";
document.querySelector('.jen').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/jennifer.png)";


document.querySelector('.wood').querySelector('.pet-name').innerHTML = "Woody";
document.querySelector('.wood').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/woody.png)";


document.querySelector('.soph').querySelector('.pet-name').innerHTML  = "Sophia";
document.querySelector('.soph').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/sophia.png)";


document.querySelector('.tim').querySelector('.pet-name').innerHTML = "Timmy";
document.querySelector('.tim').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/timmy.png)";


document.querySelector('.char').querySelector('.pet-name').innerHTML  = "Charly";
document.querySelector('.char').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/charly.png)";


document.querySelector('.scar').querySelector('.pet-name').innerHTML  = "Scarlett";
document.querySelector('.scar').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/scarlett.png)";


document.querySelector('.fred').querySelector('.pet-name').innerHTML  = "Freddie";
document.querySelector('.fred').querySelector('.pet-foto').style.backgroundImage="url(assets/PNG/freddie.png)";
...
PETCARD7.className = `pets7 ${getClass7()}`;
PETCARD8.className = `pets8 ${getClass8()}`;
PETCARD9.className = `pets9 ${getClass8()}`;
...
const slidePrev = document.querySelector('.previos');
slidePrev.addEventListener('click', getSlidePrev);



const slideNext1 = document.querySelector('.next1');
slideNext1.addEventListener('click', getSlideNext);



const slidePrev1 = document.querySelector('.previos1');
slidePrev1.addEventListener('click', getSlidePrev);
